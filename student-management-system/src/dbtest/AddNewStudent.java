...
public class AddNewStudent extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jTextField3.setToolTipText("Enter GPA");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{ 
            ...
            PreparedStatement stmt=con.prepareStatement("insert into Students_Table (id,first_name, last_name, dob, gender, GPA, address, email) values(?,?,?,?,?,?,?,?)");  
            //step4 execute query
