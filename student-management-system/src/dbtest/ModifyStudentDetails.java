...
public class ModifyStudentDetails extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(isEmailValid(email) && (gpa >= 0 && gpa <= 10) && (dob.getTime() < timeNow)){
                ...
                PreparedStatement stmt=con.prepareStatement("update Students_Table set first_name=?, last_name=?,dob=?,gender=?,GPA=?,address=?,email=? where id=?");  
                //step4 execute query
    ...
    private void jTextField6KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField6KeyReleased
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe",user,pass);
            //step3 create the statement object  
            String selectSQL = "SELECT id, first_name, last_name, dob, gender, GPA, address, email FROM Students_Table WHERE id = ?";
            ...
            while (rs.next()) {
                ...
                jTextField3.setText(String.valueOf(gpa));
